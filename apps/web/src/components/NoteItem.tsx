...
export default function NoteItem({
  ...
  return (
    <motion.div
      ...
      className={cn(
        'bg-card shadow-card rounded-xl border border-card-border p-2.5 px-3.5 space-y-2 cursor-pointer'
      )}
      ...
      <div className="flex justify-between items-end gap-2">
        <AnimatePresence mode="wait">
          <motion.h1
            ...
            className={cn('text-xl font-medium text-foreground-primary truncate min-w-0 flex-1')}
          >
